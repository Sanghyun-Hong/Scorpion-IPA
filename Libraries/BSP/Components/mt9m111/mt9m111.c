...
/** @defgroup MT9M111_Private_FunctionPrototypes
  * @{
  */
static uint32_t mt9m111_ConvertValue(uint32_t feature, uint32_t value);
/**
  * @}
  */ 
...
const unsigned char MT9M111_480x272[][2]=
{
...
const unsigned char MT9M111_VGA[][2]=
{
  {0xff, 0x00},  /* Device control register list Table 12 */
  {0x2c, 0xff},  /* Reserved                              */
  {0x2e, 0xdf},  /* Reserved                              */
...
const unsigned char MT9M111_QVGA[][2]=
{
  {0xff, 0x00},
  {0x2c, 0xff},
  {0x2e, 0xdf},
...
void mt9m111_Init(uint16_t DeviceAddr, uint32_t resolution)
{
  ...
  CAMERA_IO_Write(DeviceAddr, MT9M111_DSP_RA_DLMT, 0x01);
  CAMERA_IO_Write(DeviceAddr, MT9M111_SENSOR_COM7, 0x80);
  CAMERA_Delay(200);
  ...
  case CAMERA_R160x120:
    {
      for(index=0; index<(sizeof(MT9M111_QQVGA)/2); index++)
      {
        CAMERA_IO_Write(DeviceAddr, MT9M111_QQVGA[index][0], MT9M111_QQVGA[index][1]);
        CAMERA_Delay(1);
      } 
      break;
    }    
  case CAMERA_R320x240:
    {
      for(index=0; index<(sizeof(MT9M111_QVGA)/2); index++)
      {
        CAMERA_IO_Write(DeviceAddr, MT9M111_QVGA[index][0], MT9M111_QVGA[index][1]);
        CAMERA_Delay(1);
      } 
      break;
    }
  case CAMERA_R480x272:
    {
      for(index=0; index<(sizeof(MT9M111_480x272)/2); index++)
      {
        CAMERA_IO_Write(DeviceAddr, MT9M111_480x272[index][0], MT9M111_480x272[index][1]);
        CAMERA_Delay(2);
      }
      break;
    }
  case CAMERA_R640x480:
    {
      for(index=0; index<(sizeof(MT9M111_VGA)/2); index++)
      {
        CAMERA_IO_Write(DeviceAddr, MT9M111_VGA[index][0], MT9M111_VGA[index][1]);
        CAMERA_Delay(2);
      }
      break;
    }    
...
/**
  * @brief  Configures the MT9M111 camera feature.
  * @param  DeviceAddr: Device address on communication Bus.
  ...
  * @retval None
  */
void mt9m111_Config(uint16_t DeviceAddr, uint32_t feature, uint32_t value, uint32_t brightness_value)
{
  uint8_t value1, value2;
  uint32_t value_tmp;
  uint32_t br_value;
  
  /* Convert the input value into mt9m111 parameters */
  value_tmp = mt9m111_ConvertValue(feature, value); 
  br_value = mt9m111_ConvertValue(CAMERA_CONTRAST_BRIGHTNESS, brightness_value); 
...
/**
  * @brief  Read the MT9M111 Camera identity.
  * @param  DeviceAddr: Device address on communication Bus.
  * @retval the MT9M111 ID
  */
uint16_t mt9m111_ReadID(uint16_t DeviceAddr)
{
  ...
  /* Get the camera ID */
  return (CAMERA_IO_Read(DeviceAddr, MT9M111_SENSOR_PIDH));
}
...
*******************************************************************************/
/**
  * @brief  Convert input values into mt9m111 parameters.
  * @param  feature: Camera feature to be configured
  * @param  value: Value to be configured
  ...
  case CAMERA_BLACK_WHITE:
    {
      ...
      case CAMERA_BLACK_WHITE_BW:
        {
          ret =  MT9M111_BLACK_WHITE_BW;
          break;
        }
      case CAMERA_BLACK_WHITE_NEGATIVE:
        {
          ret =  MT9M111_BLACK_WHITE_NEGATIVE;
          break;
        }
      case CAMERA_BLACK_WHITE_BW_NEGATIVE:
        {
          ret =  MT9M111_BLACK_WHITE_BW_NEGATIVE;
          break;
        }
      case CAMERA_BLACK_WHITE_NORMAL:
        {
          ret =  MT9M111_BLACK_WHITE_NORMAL;
          break;
        }
      default:
        {
  ...
  case CAMERA_CONTRAST_BRIGHTNESS:
    {
      ...
      case CAMERA_BRIGHTNESS_LEVEL0:
        {
          ret =  MT9M111_BRIGHTNESS_LEVEL0;
          break;
        }
      case CAMERA_BRIGHTNESS_LEVEL1:
        {
          ret =  MT9M111_BRIGHTNESS_LEVEL1;
          break;
        }
      case CAMERA_BRIGHTNESS_LEVEL2:
        {
          ret =  MT9M111_BRIGHTNESS_LEVEL2;
          break;
        }
      case CAMERA_BRIGHTNESS_LEVEL3:
        {
          ret =  MT9M111_BRIGHTNESS_LEVEL3;
          break;
        }
      case CAMERA_BRIGHTNESS_LEVEL4:
        {
          ret =  MT9M111_BRIGHTNESS_LEVEL4;
          break;
        }        
      case CAMERA_CONTRAST_LEVEL0:
        {
          ret =  MT9M111_CONTRAST_LEVEL0;
          break;
        }
      case CAMERA_CONTRAST_LEVEL1:
        {
          ret =  MT9M111_CONTRAST_LEVEL1;
          break;
        }
      case CAMERA_CONTRAST_LEVEL2:
        {
          ret =  MT9M111_CONTRAST_LEVEL2;
          break;
        }
      case CAMERA_CONTRAST_LEVEL3:
        {
          ret =  MT9M111_CONTRAST_LEVEL3;
          break;
        }
      case CAMERA_CONTRAST_LEVEL4:
        {
          ret =  MT9M111_CONTRAST_LEVEL4;
          break;
        }
      default:
        {
  ...
  case CAMERA_COLOR_EFFECT:
    {
      ...
      case CAMERA_COLOR_EFFECT_ANTIQUE:
        {
          ret =  MT9M111_COLOR_EFFECT_ANTIQUE;
          break;
        }
      case CAMERA_COLOR_EFFECT_BLUE:
        {
          ret =  MT9M111_COLOR_EFFECT_BLUE;
          break;
        }
      case CAMERA_COLOR_EFFECT_GREEN:
        {
          ret =  MT9M111_COLOR_EFFECT_GREEN;
          break;
        }
      case CAMERA_COLOR_EFFECT_RED:
        {
          ret =  MT9M111_COLOR_EFFECT_RED;
          break;
        }
      default:
        {
